/*sap.ui.define([
	...
	return Controller.extend("sap.ui.app.DataBding.DataBinding.controller.App", {
...
sap.ui.define([
	...
	"sap/m/ObjectAttribute" //step 15 Aggregation Binding Using a Factory Function
		...
		productListFactory : function(sId, oContext) {
			...
			if (oContext.getProperty("UnitsInStock") === 0 && oContext.getProperty("Discontinued")) {
				...
				if (!this._oProductSimple) {
					this._oProductSimple = sap.ui.xmlfragment(sId, "sap.ui.app.DataBding.DataBinding.view.ProductSimple", this);
				}
				oUIControl = this._oProductSimple.clone();
			} else {
				// The item is available, so we will create an ObjectListItem
				if (!this._oProductExtended) {
					this._oProductExtended = sap.ui.xmlfragment(sId, "sap.ui.app.DataBding.DataBinding.view.ProductExtended", this);
				}
